...
public class UserTest {
    ...
    public void TestTwoArgsConstructor(){
        ...
        assertEquals("When using constructor of 2 args size of cards arraylist should be 0", 0, user.getCards().size());
    ...
    public void TestFullArgsConstructor(){
        ...
        for (CreditCard cc : ccs) {
            assertEquals("When using constructor with all args ccs array must match with user.cards", cc, user.getCards().get(i));
            i++;
        }
    }
